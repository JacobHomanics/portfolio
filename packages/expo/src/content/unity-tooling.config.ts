...
const projects: Array<ProjectData & { slug: string }> = [
  {
    ...
    imgSrc: "supercharged-vector2.png",
    link: "https://assetstore.unity.com/packages/tools/utilities/supercharged-vector2-305553",
    links: [{ imagePath: "github.svg", url: "https://github.com/JacobHomanics/pool-management-system" }],
  },
  {
    ...
    imgSrc: "raycast-controller.png",
    link: "https://assetstore.unity.com/packages/tools/utilities/raycast-controller-305913",
    links: [{ imagePath: "github.svg", url: "https://github.com/JacobHomanics/raycast-controller" }],
  },
  {
