...
const projects: Array<ProjectData & { slug: string }> = [
  ...
  {
    slug: "bill-murray-1000-open-edition",
...
export const data = withDetailPage("/nft-collections", projects);
