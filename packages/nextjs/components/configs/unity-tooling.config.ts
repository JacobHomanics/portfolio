...
export const data: Array<ProjectData> = [
  {
    ...
    links: [{ imagePath: "/iconLinks/github.svg", url: "https://github.com/JacobHomanics/pool-management-system" }],
  },
  {
    ...
    links: [{ imagePath: "/iconLinks/github.svg", url: "https://github.com/JacobHomanics/raycast-controller" }],
  },
  {
  ...
  },
  {
    ...
    links: [{ imagePath: "/iconLinks/github.svg", url: "https://github.com/JacobHomanics/overlap-shape" }],
  },
  {
    name: "Callbacks",
    ...
    links: [{ imagePath: "/iconLinks/github.svg", url: "https://github.com/JacobHomanics/callbacks" }],
  },
];
