...
}: // links = [],
{
  ...
  return (
    <a href={link} target="#" className="bg-primary rounded-lg p-2 h-32 w-40 md:h-44 md:w-72 lg:h-56 lg:w-80">
      ...
      >
        <div className="hover:bg-primary hover:bg-opacity-40 h-full w-full flex items-end rounded-b-lg">
          <div className="flex flex-col items-end bg-secondary bg-opacity-85 rounded-b-lg p-1 md:p-2 w-full">
