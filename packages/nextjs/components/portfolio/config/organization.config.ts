...
export const organizations = [
  { url: "https://curios.com/", icon: curios.src, name: "Curios" },
  { url: "https://www.daocoalition.org/", icon: daoCoalition.src, name: "DAO Coalition" },
  { url: "https://www.bigshottoyworks.com/", icon: bstwLogo.src, name: "Bigshot Toyworks" },
