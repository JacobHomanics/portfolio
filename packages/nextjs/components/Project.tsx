...
export const Project = ({ img }: Props) => {
  return (
    <div className="flex bg-primary p-4 rounded-lg border-2 border-indigo-500 items-center md:items-start">
      ...
      <div className="flex flex-col pl-6">
        ...
        <a href="#">
          <div className="text-2xl text-blue-600 dark:text-blue-500 hover:underline">Ladders.Vision</div>
        </a>
        {/* </Link> */}
        <div className="break-all">{shortTextExample}</div>
      </div>
    </div>
  );
};
